...
export default function Example() {
    return (
        ...
        <div className="fixed left-0 top-0 hidden h-full w-1/2 bg-background lg:block" aria-hidden="true" />
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
            ...
            <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                ...
                {pricing.tiers.map((tier) => (
                    <li key={tier.id} className="flex items-start space-x-4 py-6">
                    {/* <img
                        src={tier.imageSrc}
                    ...
                    {/* <p className="flex-none text-base font-medium text-white">{tier.price}</p> */}
                    </li>
                ))}
                </ul>
